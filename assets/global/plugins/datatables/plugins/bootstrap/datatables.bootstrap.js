...
$.extend(true, $.fn.dataTable.defaults, {
    ...
    // "dom": "<'row-fluid'<'span4'l><'span8'p>r>" +
    // "<'row-fluid'<'span12't>>" +
...
$.fn.dataTable.ext.renderer.pageButton.bootstrap = function (settings, host, idx, buttons, page, pages) {
    ...
    var attach = function (container, buttons) {
        ...
        var clickHandler = function (e) {
            e.preventDefault();
            if (!(e.data.action === 'ellipsis' || (e.data.action === 'previous' && page === 0) || (e.data.action === 'next' && page === pages - 1))) {
                    ...
                    node = $('<li>', {
                        ...
                        'id': idx === 0 && typeof button === 'string' ?
                            settings.sTableId + '_' + button : null
                                ...
                                'style': btnClass.indexOf('disabled') !== -1 ? 'cursor: not-allowed!important; text-decoration: none' : '',
                                'href': '#'
                            }).html(btnDisplay)
                        ).appendTo(container);
    ...
    var refresh = '<li class="paginate_button" style=" margin-left: 15px;"><i class="fa fa-refresh"></i></li>';
    ...
    }).append('<i title="刷新" class="fa fa-refresh"></i>');


    $(host).find('ul').append(fre).append($('<li />', {
    ...
    "bootstrap_full_number": {
        "fnInit": function (oSettings, nPaging, fnDraw) {
            ...
            $(nPaging).append(
                ...
                // '<input id="pageInput" min="1" type="number" class=""/>' +
                // '<button id="jump" class="btn" >' + oLang.sJump + '</button>' +
                // '</div>'
            );
        ...
        "fnUpdate": function (oSettings, fnDraw) {
            $("#pageInput").attr("max", oSettings.oInstance.fnPagingInfo().iTotal
            );
            var iListLength = 5;
