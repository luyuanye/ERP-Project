describe 'Morris.Bar', ->
  ...
  describe 'svg structure', ->
    ...
    it 'should contain IController rect for each bar', ->
      chart = Morris.Bar $.extend {}, defaults
  ...
  describe 'svg attributes', ->
    ...
    it 'should have IController bar with the first default color', ->
      chart = Morris.Bar $.extend {}, defaults
      $('#graph').find("rect[fill='#0b62a4']").size().should.equal 2

    it 'should have IController bar with no stroke', ->
      chart = Morris.Bar $.extend {}, defaults
  ...
  describe 'when setting bar radius', ->
    describe 'svg structure', ->
      ...
      it 'should contain IController path for each bar', ->
        chart = Morris.Bar $.extend {}, defaults
