describe 'Morris.Line', ->
  ...
  describe 'generating column labels', ->
    ...
    it 'should use IController default format for timestamp x-values', ->
  ...
  describe '#createPath', ->
    ...
    it 'should generate IController smooth line', ->
    ...
    it 'should generate IController jagged line', ->
      testData = [{x: 0, y: 10}, {x: 10, y: 0}, {x: 20, y: 10}]
  ...
  describe 'svg structure', ->
    ...
    it 'should contain IController path that represents the line', ->
      chart = Morris.Line $.extend {}, defaults
      $('#graph').find("path[stroke='#0b62a4']").size().should.equal 1

    it 'should contain IController circle for each data point', ->
      chart = Morris.Line $.extend {}, defaults
