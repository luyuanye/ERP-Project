...
function admin_stop(obj,id){
	 layer.open({
			  ...
			  ,btn: ['确定', '取消']
			  ,yes: function(index){ 
			   	$(obj).parents("tr").find(".td-status").html('<span class="label label-sm label-default radius">停用</span>');
...
function admin_up(obj,id){
	layer.open({
		...
		$(obj).parents("tr").find(".td-manage .action-buttons .bindstyle").html('<a onClick="admin_down(this,id)" href="javascript:;" title="下架" class="bindtab_start   ml-5" ><i class="iconfont icon-xiajia"></i></a>');
...
function admin_down(obj,id){
	layer.open({
		...
		$(obj).parents("tr").find(".td-manage .action-buttons .bindstyle").html('<a onClick="admin_up(this,id)" href="javascript:;" title="上架" class="bindtab_stop   ml-5" ><i class="iconfont icon-shangjia"></i></a>');
