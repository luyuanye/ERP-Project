(function (root, factory) {
    ...
    echarts.registerMap('上海', {
        ...
        "features": [{
            ...
            "properties": {"cp": [121.448224, 31.229003], "name": "静安区2个", "childNum": 1}
        }, {
            "id": "310107",
            "geometry": {
                "type": "Polygon",
            ...
            "properties": {"cp": [121.375972, 31.111658], "name": "闵行区4个", "childNum": 1}
        }, {
            "id": "310113",
            "geometry": {
                "type": "Polygon",
            ...
            "properties": {"cp": [121.489934, 31.398896], "name": "宝山区5个", "childNum": 1}
        }, {
            "id": "310114",
            "geometry": {
                "type": "Polygon",
            ...
            "properties": {"cp": [121.567706, 31.245944], "name": "浦东新区4个", "childNum": 3}
        }, {
            "id": "310116",
            "geometry": {
                "type": "MultiPolygon",
            ...
            "properties": {"cp": [121.330736, 30.724697], "name": "金山区1个", "childNum": 4}
        }, {
            "id": "310117",
            "geometry": {
                "type": "Polygon",
            ...
            "properties": {"cp": [121.458472, 30.912345], "name": "奉贤区4个", "childNum": 1}
        }, {
            "id": "310230",
            "geometry": {
                "type": "MultiPolygon",
            ...
            "properties": {"cp": [121.397516, 31.626946], "name": "崇明区3个", "childNum": 5}
        }],
        "UTF8Encoding": true
    });
}));